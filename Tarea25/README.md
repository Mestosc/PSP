...
4.  **Bucle interactivo**: La aplicación se ejecuta en un bucle, permitiendo al usuario escanear múltiples IPs y puertos hasta que escriba `salir` para terminar el programa.

El escaneo de cada puerto se realiza mediante un metodo en especifico para comprobar el puerto y la validacion se hace con un metodo propio garantizando modularidad y que el codigo para verificar si el puerto esta abierto pueda extrapolarse
